# Shopify Tailwind Starter Theme - Copilot Instructions
...
```
/home/runner/work/starter/starter/
├── .github/
...
- **src/entrypoints/theme.js** - Main JavaScript entry point
  ...
  - Exposes helpers on `window.starterNamespace`
...
- CORS is configured for `starter.myshopify.com` and local origins
...
```
WARNING: No assets folder located at /home/runner/work/starter/starter/assets. No clean attempted.
```
